...
if __name__ == '__main__':
    ...
    model_PATH = '../pretrain/weights_joao/' + args.dataset + '_' + args.pretrain_lr + '_' + args.pretrain_epoch + '_' + args.pretrain_gamma  + '_' + args.suffix + '.pt'
    result_PATH = './results_joao/' + args.dataset + '_' + str(args.n_splits) + '.res'
    result_feat = args.pretrain_lr + '_' + args.pretrain_epoch + '_' + args.pretrain_gamma + '_' + args.suffix
