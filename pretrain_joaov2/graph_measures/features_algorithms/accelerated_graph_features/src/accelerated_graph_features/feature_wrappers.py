...
def motif(graph, **kwargs):
    # sys.path.insert(0, '/home/dsi/shacharh/Projects/GraphCL_new/semisupervised_TU/pretrain_joaov2/graph_measures/'
    #                 'features_algorithms/accelerated_graph_features')
    import graph_measures.features_algorithms.accelerated_graph_features.src.accelerated_graph_features._features as feat
    # import src.accelerated_graph_features._features as feat
